...
def get_args():
    ...
    parser.add_argument('--resize-size', type=int,
                        default=256, help='validation resize size')
    parser.add_argument('--crop-size', type=int,
                        default=224, help='validation crop size')

    parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true',
                        help='evaluate model on validation set')
    # wayne modified args
    parser.add_argument('--log-folder', type=str, default='/data/wayne/train_log',
                        help="This argument should only be taken when offline test is expected.")
    
    parser.add_argument('--mode',type=str,default='base',help='To determine the model architecture.')
