...
class CUBClsDataset(Dataset):
    def __init__(self, root=None, datalist=None, transform=None, args=None):
    ...
    def __getitem__(self, idx):
        ...
        # we can sure that images have been converted to RGB already
        image = Image.open(os.path.join(
            self.root, 'images/', image_name)).convert('RGB')
